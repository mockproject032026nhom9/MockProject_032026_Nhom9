...
public class NotaryCommissionConfiguration : IEntityTypeConfiguration<NotaryCommission>
{
    ...
    {
        builder.ToTable("NotaryCommissions");
        builder.HasKey(c => c.Id);
        builder.Property(c => c.Id).HasColumnName("id");
        builder.Property(c => c.NotaryId).HasColumnName("notary_id");
        builder.Property(c => c.CommissionState).HasColumnName("commission_state").HasMaxLength(10).IsRequired();
        ...
        builder.HasIndex(c => c.CommissionState);
